...
def test_MH_sampler():
    ...
    while i < iterations:
        ...
        # print indicator_EPF
        print(f'The indicator for the extended particle filter is: {indicator_EPF}, the time is {datetime.now().strftime("%H:%M:%S")}.')
        ...
        print(f'The indicator for the particle filter is: {indicator_PF}, the time is {datetime.now().strftime("%H:%M:%S")}.')
